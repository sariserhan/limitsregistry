...
export type Claim = { id: string; specificationVersionId: string; claimType: ClaimType; relation: ClaimRelation; value: ExactValue; status: ClaimStatus; epistemicStatus: EpistemicStatus; evidenceIds: string[]; author: string; year: number; source: string };
