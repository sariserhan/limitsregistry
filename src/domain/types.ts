...
export type LimitKind = "OPTIMIZATION" | "FUNDAMENTAL_CONSTANT" | "THEORETICAL_BOUND" | "EMPIRICAL_FRONTIER" | "OBSERVED_RECORD" | "IMPOSSIBILITY_RESULT";
export type CanonicalLimitStatus = "OPEN" | "CLOSED" | "EXACT" | "DISPUTED" | "RETIRED";
export type EvidenceBasis = "MATHEMATICAL_PROOF" | "FORMAL_PROOF" | "COMPUTATIONAL_PROOF" | "THEORETICAL_DERIVATION" | "EXPERIMENT" | "CONSTRUCTION" | "OBSERVATION" | "ESTIMATE";
...
export type Evidence = { id: string; type: EvidenceType; label: string; method?: string; verificationLevel?: VerificationLevel; location?: string; sourceUrl?: string; attribution?: Record<string, string>; abstract?: string };
