...
export const HUMAN_ANIMAL_RECORDS: HumanAnimalRecord[] = [
  ...
  },
  {
    ...
    slug: "largest-living-organism",
    title: "Largest known living organism",
    subcategory: "Botany",
    direction: "MAXIMIZE",
    metricName: "Estimated area covered by a single genetically identical clonal organism",
    unit: "ha",
    formalStatement: "The greatest area covered by any single organism confirmed to be one genetic individual, as established by genetic sampling.",
    summary: "Pando, a colony of quaking aspen (Populus tremuloides) in Utah, USA, covers approximately 43 hectares (106 acres) with an estimated 47,000 genetically identical stems, all connected by a single root system — making it the largest known organism by area. It is also among the oldest, with root-system age estimates ranging from 9,000 to 80,000 years depending on methodology.",
    value: "43",
