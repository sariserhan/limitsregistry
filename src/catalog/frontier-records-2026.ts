...
export const FRONTIER_RECORDS_2026: FrontierRecord[] = [
  ...
  {
    registryNumber: "LR-LIGHTNING-FLASH-DISTANCE", slug: "longest-lightning-flash-distance", title: "Longest lightning flash (distance)",
    category: "Earth & Climate", subcategory: "Extreme Weather", direction: "MAXIMIZE",
    metricName: "Horizontal distance covered by a single lightning flash", unit: "km",
    formalStatement: "The greatest horizontal distance covered by a single, continuous lightning flash (a 'megaflash'), as certified by the World Meteorological Organization's Committee on Weather and Climate Extremes.",
    summary: "A single lightning flash spanning 829 ± 8 km (515 ± 5 miles), from eastern Texas to near Kansas City, occurred on October 22, 2017 and was identified retrospectively using satellite lightning-mapper data; the WMO certified it as the new world record on July 31, 2025, surpassing the previous 768 km record from April 2020.",
    value: "829",
    claimType: "CONSTRUCTION", epistemicStatus: "SOURCE_CONFIRMED", limitStatus: "OPEN",
    methodSummary: "Identified via Geostationary Lightning Mapper satellite data and certified by the WMO Committee on Weather and Climate Extremes, published in the Bulletin of the American Meteorological Society.",
    source: { title: "WMO certifies megaflash lightning record in USA", url: "https://wmo.int/news/media-centre/wmo-certifies-megaflash-lightning-record-usa", date: "2017-10-22", location: "Eastern Texas to near Kansas City, USA" },
  },
  {
    registryNumber: "LR-LIGHTNING-FLASH-DURATION", slug: "longest-lightning-flash-duration", title: "Longest lightning flash (duration)",
    category: "Earth & Climate", subcategory: "Extreme Weather", direction: "MAXIMIZE",
    metricName: "Duration of a single continuous lightning flash", unit: "s",
    formalStatement: "The longest duration of a single, continuous lightning flash, as certified by the World Meteorological Organization's Committee on Weather and Climate Extremes.",
    summary: "A single lightning flash over Uruguay and northern Argentina lasted 17.102 ± 0.002 seconds on June 18, 2020 — about 85 times longer than an average lightning bolt — and was certified by the WMO as the world record on February 1, 2022.",
    value: "17.102",
    claimType: "CONSTRUCTION", epistemicStatus: "SOURCE_CONFIRMED", limitStatus: "OPEN",
    methodSummary: "Identified via Geostationary Lightning Mapper satellite data and certified by the WMO Committee on Weather and Climate Extremes.",
    source: { title: "WMO certifies two megaflash lightning records", url: "https://wmo.int/news/media-centre/wmo-certifies-two-megaflash-lightning-records", date: "2020-06-18", location: "Uruguay and northern Argentina" },
  },
  {
    registryNumber: "LR-PI-DIGITS-COMPUTED", slug: "most-digits-of-pi-computed", title: "Most decimal digits of pi computed",
    category: "Computing", subcategory: "Numerical Computation", direction: "MAXIMIZE",
    metricName: "Verified decimal digits of pi computed", unit: "digits",
    formalStatement: "The greatest number of decimal digits of pi ever computed and independently verified.",
    summary: "StorageReview and Micron Technology computed pi to 314 trillion decimal digits using the Chudnovsky algorithm on a single Dell PowerEdge server, completing a 110-day run on November 18, 2025 — the current record, surpassing the previous 300-trillion-digit computation. The result was independently cross-verified using the Bailey–Borwein–Plouffe formula to spot-check digits.",
    value: "314000000000000",
    claimType: "CONSTRUCTION", epistemicStatus: "SOURCE_CONFIRMED", limitStatus: "OPEN",
    methodSummary: "Computed with the Chudnovsky algorithm (y-cruncher software) on a single server; cross-verified against the Bailey–Borwein–Plouffe formula.",
    source: { title: "Tom's Hardware — Pi calculation world record shattered at 314 trillion digits", url: "https://www.tomshardware.com/pc-components/storage/pi-calculating-record-shattered-at-314-trillion-digits-with-a-four-month-run-on-a-single-server-storagereview-retakes-the-crown-thanks-to-storage-bandwidth", date: "2025-11-18", location: "StorageReview lab, USA" },
  },
];
