...
- Sponsor discovery: the shared navbar and footer, category pages, individual record pages, bounty listings, homepage previews, Open Limits, search results, and relevant article endings include sponsorship invitations. Contextual links preselect a published record or category; the copy promises a paid sponsor panel, not guaranteed reach or research outcomes.
