...
export default async function GraphPage({ searchParams }: Props) {
  ...
  return <main className="console-page"><header><Link className="brand" href="/console/research">← Research Infrastructure</Link><Link href="/dependencies">Public graph ↗</Link></header>
    <p className="section-kicker">Knowledge graph</p><h1>Limit dependencies</h1><p className="lede">An arrow reads source → target. For example, “A reduces to B” means solving B can solve A. Every new edge is private until an editor accepts it.</p>
