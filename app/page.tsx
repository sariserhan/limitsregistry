...
import { browseClaims as sharedClaims } from "../src/domain/registry";
import { formatExact, publishedLimits as sharedLimits } from "../src/domain/published";


const limits = sharedLimits;
const claims = sharedClaims;
