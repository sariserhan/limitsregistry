...
export function EnquiryForm({options,categories,initialCategory="",initialLimitId=""}:{options:{id:string;registryNumber:string;title:string}[];categories:{category:string;count:number}[];initialCategory?:string;initialLimitId?:string}) {
