...
export default async function OpenLimitsPage({ searchParams }: Props) {
  ...
  return <main className="directory-page open-limits-page">
    <PublicHeader />
    ...
    <aside className="open-limits-sponsor" aria-label="Support open research">
      <SponsorCallout category={field || undefined} context={field ? "category" : "research"} heading="Help fund the next advance." />
    </aside>
