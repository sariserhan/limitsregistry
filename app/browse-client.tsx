...
export default function Home({ initialLimits }: BrowseClientProps) {
  ...
  const fieldPageHref = category === "All categories" ? null : "/categories/" + categorySlug(category);
