...
type BrowseClientProps = { initialLimits: PublishedLimit[]; stats: RegistryStats | null };
...
export default function Home({ initialLimits, stats }: BrowseClientProps) {
  ...
  return <main className="app-shell">
    ...
    <footer><span>LR / 2026</span><span>Evidence before assertion.</span><span className="footer-links"><a href="/about">About</a><a href="/methodology">Methodology</a><a href="/editorial-policy">Editorial policy</a><a href="/support">Support</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></span></footer>
  </main>;
}
