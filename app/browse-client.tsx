...
type BrowseClientProps = { initialLimits: PublishedLimit[]; stats: RegistryStats | null; recentBreakthroughs: RecentBreakthrough[]; featuredBounties: FeaturedBounty[] };
...
export default function Home({ initialLimits, stats, recentBreakthroughs, featuredBounties }: BrowseClientProps) {
