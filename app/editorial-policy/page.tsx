...
<h2>Corrections</h2><p>Send corrections to <a href="mailto:support@limitsregistry.com">support@limitsregistry.com</a> with the relevant Registry ID, source, and precise proposed change.</p>
</InfoPage>; }
